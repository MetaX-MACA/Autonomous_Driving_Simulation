...
class BasicTrainer(nn.Module):
    ...
    def load_state_dict(self, state_dict: dict, load_only_model: bool =True, strict: bool = True, delte_ids=[]):
        ...
        for class_name in self.models.keys():
            ...
            if class_name not in model_state_dict:
                ...
                continue
            if class_name in ["RigidNodes", "DeformableNodes"]:
                msg = model.load_state_dict(model_state_dict[class_name], delte_ids=delte_ids, strict=strict)
            else:
    ...
    def resume_from_checkpoint(
        ...
        self.load_state_dict(state_dict, load_only_model=load_only_model, strict=True, delte_ids=delte_ids)
