...
if __name__ == "__main__":
    ...
    # delete 3dgs
    parser.add_argument("--delete_ids", nargs='*', type=int, default=[], help='List of id to delete')
    args = parser.parse_args()
    main(args)
    # export PYTHONPATH=/workspace/drivestudio/
    # rebuild:
    # python3 tools/eval.py --resume_from /workspace/drivestudio/work_dirs/UrbanGSim/788/checkpoint_final.pth

    # delete 3dgs
    # python3 tools/eval.py --delete_ids 1 --render_video_postfix delete_3dgs  --resume_from /workspace/drivestudio/work_dirs/UrbanGSim/788/checkpoint_final.pth 
